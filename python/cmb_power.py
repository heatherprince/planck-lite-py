...
def get_theoretical_TT_unbinned_power_spec_C_ell(class_params, ellmin=2, ellmax=2508):
    cosmo = Class()
...
def get_theoretical_TT_TE_EE_unbinned_power_spec_D_ell(class_params, ellmin=2, ellmax=2508):
    cosmo = Class()
    cosmo.set(class_params)
    cosmo.compute()
    cls = cosmo.lensed_cl(3000)
